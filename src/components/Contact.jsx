...
const socialLinks = [
    {
      href: 'https://github.com/allknowledge34',
    ...
    {
      href: 'https://www.linkedin.com/in/sachin-kumar-355203340?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/aicodinghub/',
              ...
              >
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email"
                        required
                        placeholder="allknowledge34@gmail.com"
                        className="text-field reveal-up"
                        />
                    </div>
                </div>
